...
const items = [
  ...
  { img: '/terrain-inte-1.jpg', 
    ...
    <div>
      <p>
        Un espace à ciel ouvert au cœur de Paris :
      </p>
      <ul className="list-none">
        <li className="py-1">🌿 Terrasse végétalisée, guinguette colorée, espaces lounge et terrain de pétanque.</li>
        <li className="py-1">L’endroit idéal pour se détendre, partager un verre et profiter d’une ambiance conviviale et dépaysante.</li>
        <li className="py-1">👉 Ouvert tous les jours – Privatisez l’espace pour vos événements.</li>
      </ul>
    </div>
   },
]
