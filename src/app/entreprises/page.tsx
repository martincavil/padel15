...
const eventSchema = {
  ...
  description:
    "Lieu d'événements corporate à Paris 15ème — team building, tournois, soirées privées.",
  address: {
    "@type": "PostalAddress",
...
const OFFRES = [
  {
    ...
    prix: "Sur devis",
    description:
      "La formule idéale pour renforcer la cohésion de vos équipes dans un cadre atypique.",
    inclus: [
  ...
  },
  {
    ...
    prix: "Sur devis",
    description:
      "Affrontez-vous entre équipes dans un format compétitif et convivial, clé en main.",
    inclus: [
  ...
  },
  {
    ...
    prix: "Sur devis",
    description:
      "Privatisez notre guinguette et terrasse pour votre afterwork, anniversaire ou soirée de fin d'année.",
    inclus: [
...
const CHIFFRES = [
  { valeur: "100+", label: "Entreprises clientes" },
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-16 space-y-20">
        ...
        <AnimatedSection>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {CHIFFRES.map((c) => (
              ...
              >
                <div className="font-buzz text-4xl text-brand mb-1">
                  {c.valeur}
                </div>
          ...
          <AnimatedSection>
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 max-w-lg mx-auto">
                Chaque événement est unique. Nos formules sont des points de
                départ — nous adaptons tout à vos besoins.
              </p>
            </div>
          </AnimatedSection>
        ...
        {/* Clients logos */}
        <AnimatedSection>
          <h2 className="font-buzz text-3xl text-center mb-2">
            Ils nous ont fait confiance
          </h2>
          <p className="text-center text-gray-500 mb-8">
            Plus de 21 entreprises de premier plan ont choisi Padel 15 pour
            leurs événements.
          </p>
        ...
        <div
          id="formulaire"
          className="grid grid-cols-1 lg:grid-cols-3 gap-12 scroll-mt-24"
        >
          {/* Left — infos */}
          <div className="lg:col-span-1 space-y-6">
            <div>
              <h2 className="font-buzz text-3xl mb-3">
                Parlons de votre projet
              </h2>
              <p className="text-gray-600 leading-relaxed">
                Notre équipe vous répond sous 24h ouvrées avec une proposition
                personnalisée.
              </p>
            </div>
            ...
            {/* <div className="bg-gray-50 rounded-2xl p-5">
              ...
              <p className="text-gray-500 text-xs mb-3">
                Toutes nos formules et tarifs en détail — à partager avec votre
                direction.
              </p> */}
              ...
              {process.env.NEXT_PUBLIC_TALLY_FORM_ID ? (
                ...
                <div className="p-8 space-y-6">
                  <p className="text-gray-600">
                    Décrivez-nous votre projet par email ou téléphone — nous
                    vous répondons sous 24h avec une proposition sur-mesure.
                  </p>
